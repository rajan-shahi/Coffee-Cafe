...
import { Toaster, toast } from "react-hot-toast"; // Import the Toaster component and toast function

const ContactSection = () => {
  const handleSubmit = (event) => {
    event.preventDefault();
    // Example form submission logic (replace with your actual logic)
      ...
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-6 font-[sans-serif]">
        <div>
          ...
          <ul className="mt-12 space-y-8">
            ...
            <li data-aos="fade-up" className="flex items-center">
              ...
              <a href="tel:+158996888" className="text-gray-300 text-sm ml-4">
                +977 9866448106
              </a>
            </li>
            <li data-aos="fade-up" className="flex items-center">
        ...
        <div>
          ...
          >
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 mt-6 text-lg font-medium text-white rounded-md bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary-dark"
            >
              Send Message
            </button>
          </form>
