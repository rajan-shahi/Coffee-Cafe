    ...
    <div className=" md:px-0 px-4">
      <div className="  max-w-6xl max-lg:max-w-3xl mx-auto   bg-secondary rounded-lg">
        <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
          ...
          <div>
            <form onSubmit={"submit"} className=" bg-gray-100 md:p-10 p-6 rounded-md">
              <div className="flex items-center gap-4">
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2  bg-white border border-gray-400 rounded-md f outline-primary/80"
                  />
                </div>
                <div className="w-1/2">
                  <label className="block mb-2 text-sm text-gray-700">
              ...
              <button
                type="submit"
                className="w-full px-4 py-2 mt-6 text-lg font-medium text-white  rounded-md bg-primary "
              >
                Send Message
              </button>
            </form>
