        ...
        <div className="container py-2">
          <div className="flex justify-between items-center">
            <div data-aos="fade-down" data-aos-once="true">
              <Link
                to="/"
                className=" font-semibold text-white/95 text-2xl sm:text-3xl flex justify-center items-center gap-2 tracking-wider font-cursive"
              >
              ...
              <ul className="hidden sm:flex items-center gap-4">
                {Menu.map((menu) => (
                  <li key={menu.id}>
                    <Link
                      to={menu.link}
                      className="inline-block text-xl py-4 px-4 text-white/95  hover:text-white/70 duration-200"
                    >
                      {menu.name}
                    </Link>
                  </li>
